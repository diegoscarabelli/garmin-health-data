...
- **Three new schema tables (total 39 → 42)**: `activity_event`, `activity_hrv`, and `swim_length`, plus new FIT `session`-message metrics captured into the existing `supplemental_activity_metric` table. Each is detailed below.
